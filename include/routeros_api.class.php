...
/*
include("./config/_token.php");
if(empty($_token)){
    $file = fopen("./config/_token.php","w");
    $__token = '<?php  if(substr($_SERVER["REQUEST_URI"], -10) == "_token.php"){header("HTTP/1.0 403 Forbidden", true, 403); echo "403 Forbidden";die();}
$_token = '.round(rand(123456789012345,999999999999999)).';
?>';
    fwrite($file,$__token);
    fclose($file);
}
